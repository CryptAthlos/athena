...
public:
  ...
  MultiVersionTest(const CryptAthlos::Currency& currency, System::Dispatcher& d, const Tests::Common::BaseFunctionalTestsConfig& config, Logging::ILogger& log) :
  ...
  void run() {
    ...
    CryptAthlos::AccountBase stashAddress;
