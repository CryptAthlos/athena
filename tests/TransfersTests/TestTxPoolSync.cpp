...
namespace {
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterANodeIsConnectedToAnotherIfTheirBlockchainsAreSynchronized) {
    ...
    std::unique_ptr<CryptAthlos::INode> node0;
    std::unique_ptr<CryptAthlos::INode> node1;
    std::unique_ptr<CryptAthlos::INode> node2;
    std::unique_ptr<CryptAthlos::INode> node3;
    ...
    std::vector<std::unique_ptr<CryptAthlos::ITransactionReader>> poolTxs1;
    std::vector<std::unique_ptr<CryptAthlos::ITransactionReader>> poolTxs2;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterTimedBlockchainsSynchronization) {
    ...
    std::unique_ptr<CryptAthlos::INode> node2;
    std::unique_ptr<CryptAthlos::INode> node3;
    std::unique_ptr<CryptAthlos::INode> node4;
    ...
    std::vector<std::unique_ptr<CryptAthlos::ITransactionReader>> poolTxs2;
    std::vector<std::unique_ptr<CryptAthlos::ITransactionReader>> poolTxs3;
    std::vector<std::unique_ptr<CryptAthlos::ITransactionReader>> poolTxs4;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterSwitchingToAlternativeChain) {
    ...
    CryptAthlos::Block blockTemplate2;
