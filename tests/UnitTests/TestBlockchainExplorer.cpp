...
TEST_F(BlockchainExplorerTests, getRewardBlocksWindow) {
  ASSERT_EQ(blockchainExplorer.getRewardBlocksWindow(), parameters::CRYPTATHLOS_REWARD_BLOCKS_WINDOW);
}
...
TEST_F(BlockchainExplorerTests, getFullRewardMaxBlockSize) {
  ASSERT_EQ(blockchainExplorer.getFullRewardMaxBlockSize(1), parameters::CRYPTATHLOS_BLOCK_GRANTED_FULL_REWARD_ZONE);
  ASSERT_EQ(blockchainExplorer.getFullRewardMaxBlockSize(2), parameters::CRYPTATHLOS_BLOCK_GRANTED_FULL_REWARD_ZONE);
}
