...
TEST_F(decompose_amount_into_digits_test, is_correct_0)
{
  ...
  CryptAthlos::decompose_amount_into_digits(0, 0, m_chunk_handler, m_dust_handler);
...
{
  std::vector<uint64_t> expected_chunks;
  CryptAthlos::decompose_amount_into_digits(0, 10, m_chunk_handler, m_dust_handler);
  ASSERT_EQ(m_chunk_handler.m_chunks, expected_chunks);
  ASSERT_EQ(m_dust_handler.m_has_dust, false);
}
...
TEST_F(decompose_amount_into_digits_test, is_correct_2)
{
  ...
  CryptAthlos::decompose_amount_into_digits(10, 0, m_chunk_handler, m_dust_handler);
  ASSERT_EQ(m_chunk_handler.m_chunks, expected_chunks);
  ASSERT_EQ(m_dust_handler.m_has_dust, false);
}
...
TEST_F(decompose_amount_into_digits_test, is_correct_3)
{
  ...
  CryptAthlos::decompose_amount_into_digits(10, 10, m_chunk_handler, m_dust_handler);
  ASSERT_EQ(m_chunk_handler.m_chunks, expected_chunks);
...
TEST_F(decompose_amount_into_digits_test, is_correct_4)
{
  ...
  std::vector<uint64_t> expected_chunks;
  CryptAthlos::decompose_amount_into_digits(8100, 1000000, m_chunk_handler, m_dust_handler);
  ASSERT_EQ(m_chunk_handler.m_chunks, expected_chunks);
  ASSERT_EQ(m_dust_handler.m_dust, expected_dust);
}
...
TEST_F(decompose_amount_into_digits_test, is_correct_5)
{
  ...
  VEC_FROM_ARR(expected_chunks);
  CryptAthlos::decompose_amount_into_digits(8900100, 10, m_chunk_handler, m_dust_handler);
  ASSERT_EQ(m_chunk_handler.m_chunks, expected_chunks);
  ASSERT_EQ(m_dust_handler.m_has_dust, false);
}
...
TEST_F(decompose_amount_into_digits_test, is_correct_6)
{
  ...
  CryptAthlos::decompose_amount_into_digits(8900100, 1000, m_chunk_handler, m_dust_handler);
  ASSERT_EQ(m_chunk_handler.m_chunks, expected_chunks);
  ASSERT_EQ(m_dust_handler.m_dust, expected_dust);
}
