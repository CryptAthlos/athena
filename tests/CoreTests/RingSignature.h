...
public:
  ...
  bool check_balances_1(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_balances_2(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
