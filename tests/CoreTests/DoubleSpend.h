...
public:
  ...
  bool mark_invalid_tx(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_block(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_double_spend(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events);

private:
  CryptAthlos::Block m_last_valid_block;
...
protected:
  ...
  CryptAthlos::AccountBase m_bob_account;
  CryptAthlos::AccountBase m_alice_account;
  CryptAthlos::KeyPair m_outputTxKey;
