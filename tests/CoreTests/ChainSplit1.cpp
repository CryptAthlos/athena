...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_2(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_1(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<CryptAthlos::Block>(events[8])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 2);
  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched2(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<CryptAthlos::Block>(events[14])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 3);
  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched_back(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<CryptAthlos::Block>(events[19])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);

  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_1(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<CryptAthlos::Block>(events[26])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);

  return true;
}//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_2(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<CryptAthlos::Block>(events[28])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);
  return true;
}
//-----------------------------------------------------------------------------------------------------
/*
bool gen_simple_chain_split_1::check_orphaned_chain_1(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_alternative(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_2(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_main(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_38(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_39(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_40(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_41(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
