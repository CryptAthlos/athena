...
//-----------------------------------------------------------------------------------------------------
bool gen_chain_switch_1::check_split_not_switched(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_chain_switch_1::check_split_switched(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
