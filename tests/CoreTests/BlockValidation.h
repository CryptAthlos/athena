...
public:
  ...
  bool check_block_verification_context(const CryptAthlos::block_verification_context& bvc, size_t eventIdx, const CryptAthlos::Block& /*blk*/) {
  ...
  bool check_block_purged(CryptAthlos::core& c, size_t eventIdx, const std::vector<test_event_entry>& events) {
  ...
  bool markInvalidBlock(CryptAthlos::core& c, size_t eventIdx, const std::vector<test_event_entry>& events) {
...
struct CheckBlockAccepted : public test_chain_unit_base {
  ...
  bool check_block_accepted(CryptAthlos::core& c, size_t /*eventIdx*/, const std::vector<test_event_entry>& /*events*/) {
...
struct gen_block_invalid_prev_id : public CheckBlockPurged
{
  ...
  bool generate(std::vector<test_event_entry>& events) const;
  bool check_block_verification_context(const CryptAthlos::block_verification_context& bvc, size_t event_idx, const CryptAthlos::Block& /*blk*/);
};
...
struct gen_block_invalid_binary_format : public test_chain_unit_base
{
  ...
  bool generate(std::vector<test_event_entry>& events) const;
  bool check_block_verification_context(const CryptAthlos::block_verification_context& bvc, size_t event_idx, const CryptAthlos::Block& /*blk*/);
  bool check_all_blocks_purged(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool corrupt_blocks_boundary(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
