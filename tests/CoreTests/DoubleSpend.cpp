...
bool gen_double_spend_in_different_chains::check_double_spend(CryptAthlos::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& events)
{
...
bool DoubleSpendBase::check_tx_verification_context(const CryptAthlos::tx_verification_context& tvc, bool tx_added, size_t event_idx, const CryptAthlos::Transaction& /*tx*/)
{
...
bool DoubleSpendBase::check_block_verification_context(const CryptAthlos::block_verification_context& bvc, size_t event_idx, const CryptAthlos::Block& /*block*/)
{
...
bool DoubleSpendBase::mark_last_valid_block(CryptAthlos::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& /*events*/)
{
  m_last_valid_block = c.get_tail_id();
  return true;
}

bool DoubleSpendBase::mark_invalid_tx(CryptAthlos::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
  m_invalid_tx_index = ev_index + 1;
  return true;
}

bool DoubleSpendBase::mark_invalid_block(CryptAthlos::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
  m_invalid_block_index = ev_index + 1;
  return true;
}

bool DoubleSpendBase::check_double_spend(CryptAthlos::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& events)
{
