...
bool gen_ring_signature_1::check_balances_1(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_1::check_balances_2(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_2::check_balances_1(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_2::check_balances_2(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_big::check_balances_1(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_big::check_balances_2(CryptAthlos::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
