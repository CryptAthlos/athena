...
int main(int argc, char* argv[])
{
  ...
  else if (command_line::get_arg(vm, arg_generate_and_play_test_data))
  {
    ...
    //GENERATE_AND_PLAY(gen_ring_signature_big); // Takes up to XXX hours (if CRYPTATHLOS_MINED_MONEY_UNLOCK_WINDOW == 10)
    ...
    //GENERATE_AND_PLAY_EX_2VER(gen_block_invalid_binary_format); // Takes up to 30 minutes, if CRYPTATHLOS_MINED_MONEY_UNLOCK_WINDOW == 10
