...
public:
  RpcServer(System::Dispatcher& dispatcher, Logging::ILogger& log, core& c, NodeServer& p2p, const ICryptAthlosProtocolQuery& protocolQuery);
...
private:
  ...
  core& m_core;
  NodeServer& m_p2p;
  const ICryptAthlosProtocolQuery& m_protocolQuery;
};
