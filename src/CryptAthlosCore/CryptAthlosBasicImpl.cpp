...
namespace CryptAthlos {
  ...
  //-----------------------------------------------------------------------
  bool operator ==(const CryptAthlos::Transaction& a, const CryptAthlos::Transaction& b) {
    return getObjectHash(a) == getObjectHash(b);
  }
  //-----------------------------------------------------------------------
  bool operator ==(const CryptAthlos::Block& a, const CryptAthlos::Block& b) {
    return CryptAthlos::get_block_hash(a) == CryptAthlos::get_block_hash(b);
  }
}
