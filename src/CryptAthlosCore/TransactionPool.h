...
#include "CryptAthlosCore/ITimeProvider.h"
#include "CryptAthlosCore/ITransactionValidator.h"
#include "CryptAthlosCore/ITxPoolObserver.h"
...
namespace CryptAthlos {
  ...
  public:
    OnceInTimeInterval(unsigned interval, CryptAthlos::ITimeProvider& timeProvider)
  ...
  private:
    ...
    unsigned m_interval;
    CryptAthlos::ITimeProvider& m_timeProvider;
  };
  ...
  public:
    tx_memory_pool(
      ...
      CryptAthlos::ITransactionValidator& validator,
      CryptAthlos::ITimeProvider& timeProvider,
      Logging::ILogger& log);
  ...
  private:
    ...
    CryptAthlos::ITransactionValidator& m_validator;
    CryptAthlos::ITimeProvider& m_timeProvider;
