...
#include "CryptAthlosCore/BlockIndex.h"
#include "CryptAthlosCore/Checkpoints.h"
#include "CryptAthlosCore/Currency.h"
#include "CryptAthlosCore/IBlockchainStorageObserver.h"
#include "CryptAthlosCore/ITransactionValidator.h"
#include "CryptAthlosCore/SwappedVector.h"
...
#include "CryptAthlosCore/MessageQueue.h"
#include "CryptAthlosCore/BlockchainMessages.h"
#include "CryptAthlosCore/IntrusiveLinkedList.h"
...
namespace CryptAthlos {
  ...
  using CryptAthlos::BlockInfo;
  class Blockchain : public CryptAthlos::ITransactionValidator {
  public:
    ...
    bool handleGetObjects(NOTIFY_REQUEST_GET_OBJECTS_request& arg, NOTIFY_RESPONSE_GET_OBJECTS_request& rsp); //Deprecated. Should be removed with CryptAthlosProtocolHandler.
  ...
  private:
    ...
    Blocks m_blocks;
    CryptAthlos::BlockIndex m_blockIndex;
