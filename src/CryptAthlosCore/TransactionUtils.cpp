...
bool checkInputsKeyimagesDiff(const CryptAthlos::TransactionPrefix& tx) {
...
const TransactionInput& getInputChecked(const CryptAthlos::TransactionPrefix& transaction, size_t index) {
...
const TransactionInput& getInputChecked(const CryptAthlos::TransactionPrefix& transaction, size_t index, TransactionTypes::InputType type) {
...
const TransactionOutput& getOutputChecked(const CryptAthlos::TransactionPrefix& transaction, size_t index) {
...
const TransactionOutput& getOutputChecked(const CryptAthlos::TransactionPrefix& transaction, size_t index, TransactionTypes::OutputType type) {
...
bool findOutputsToAccount(const CryptAthlos::TransactionPrefix& transaction, const AccountPublicAddress& addr,
