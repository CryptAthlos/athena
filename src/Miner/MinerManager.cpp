...
MinerManager::MinerManager(System::Dispatcher& dispatcher, const CryptAthlos::MiningConfig& config, Logging::ILogger& logger) :
...
void MinerManager::startMining(const CryptAthlos::BlockMiningParameters& params) {
...
void MinerManager::adjustBlockTemplate(CryptAthlos::Block& blockTemplate) const {
