...
inline std::error_code make_error_code(CryptAthlos::error::WalletServiceErrorCode e) {
  return std::error_code(static_cast<int>(e), CryptAthlos::error::WalletServiceErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<CryptAthlos::error::WalletServiceErrorCode>: public true_type {};
