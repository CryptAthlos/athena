...
namespace CryptAthlos {
  ...
  struct IP2pEndpoint {
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const CryptAthlos::CryptAthlosConnectionContext& context) = 0;
    virtual uint64_t get_connections_count()=0;
    virtual void for_each_connection(std::function<void(CryptAthlos::CryptAthlosConnectionContext&, PeerIdType)> f) = 0;
  ...
  struct p2p_endpoint_stub: public IP2pEndpoint {
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const CryptAthlos::CryptAthlosConnectionContext& context) override { return true; }
