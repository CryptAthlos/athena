...
#include "CryptAthlosCore/OnceInInterval.h"
...
namespace CryptAthlos
{
  ...
  struct P2pConnectionContext : public CryptAthlosConnectionContext {
  public:
    ...
    P2pConnectionContext(P2pConnectionContext&& ctx) : 
      CryptAthlosConnectionContext(std::move(ctx)),
      context(ctx.context),
      peerId(ctx.peerId),
  ...
  public:
    ...
    NodeServer(System::Dispatcher& dispatcher, CryptAthlos::CryptAthlosProtocolHandler& payload_handler, Logging::ILogger& log);
    ...
    CryptAthlos::CryptAthlosProtocolHandler& get_payload_object();
    ...
    CryptAthlos::PeerlistManager& getPeerlistManager() { return m_peerlist; }
  ...
  private:
    ...
    bool handshake(CryptAthlos::LevinProtocol& proto, P2pConnectionContext& context, bool just_take_peerlist = false);
    bool timedSync();
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const CryptAthlosConnectionContext& context) override;
    virtual void for_each_connection(std::function<void(CryptAthlos::CryptAthlosConnectionContext&, PeerIdType)> f) override;
    ...
    bool idle_worker();
    bool handle_remote_peerlist(const std::list<PeerlistEntry>& peerlist, time_t local_time, const CryptAthlosConnectionContext& context);
    ...
    CryptAthlosProtocolHandler& m_payload_handler;
