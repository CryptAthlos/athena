...
namespace CryptAthlos
{
  ...
  /*                                                                      */
  /************************************************************************/
  class simple_wallet : public CryptAthlos::INodeObserver, public CryptAthlos::IWalletLegacyObserver, public CryptAthlos::INodeRpcProxyObserver {
  public:
    simple_wallet(System::Dispatcher& dispatcher, const CryptAthlos::Currency& currency, Logging::LoggerManager& log);
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(CryptAthlos::simple_wallet& simple_wallet)
    ...
    private:
      CryptAthlos::simple_wallet& m_simple_wallet;
  ...
  private:
    ...
    std::unique_ptr<CryptAthlos::NodeRpcProxy> m_node;
