...
inline std::error_code make_error_code(CryptAthlos::error::BlockchainExplorerErrorCodes e) {
  return std::error_code(static_cast<int>(e), CryptAthlos::error::BlockchainExplorerErrorCategory::INSTANCE);
}
