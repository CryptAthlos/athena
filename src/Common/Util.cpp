...
std::string get_nix_version_display_string()
{
  ...
  {
    //namespace fs = boost::filesystem;
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\CRYPTATHLOS_NAME
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\CRYPTATHLOS_NAME
    // Mac: ~/Library/Application Support/CRYPTATHLOS_NAME
    // Unix: ~/.CRYPTATHLOS_NAME
    std::string config_folder;
#ifdef WIN32
    // Windows
    config_folder = get_special_folder_path(CSIDL_APPDATA, true) + "/" + CryptAthlos::CRYPTATHLOS_NAME;
#else
    std::string pathRet;
    ...
    config_folder =  (pathRet + "/" + CryptAthlos::CRYPTATHLOS_NAME);
#else
    // Unix
    config_folder = (pathRet + "/." + CryptAthlos::CRYPTATHLOS_NAME);
#endif
