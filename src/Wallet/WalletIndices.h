...
struct WalletRecord {
  ...
  CryptAthlos::ITransfersContainer* container = nullptr;
...
typedef boost::multi_index_container <
  ...
  boost::multi_index::indexed_by <
    ...
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransfersContainerIndex>,
      BOOST_MULTI_INDEX_MEMBER(WalletRecord, CryptAthlos::ITransfersContainer*, container) >
  >
> WalletsContainer;

struct UnlockTransactionJob {
  uint32_t blockHeight;
  CryptAthlos::ITransfersContainer* container;
...
typedef boost::multi_index_container <
  CryptAthlos::WalletTransaction,
  boost::multi_index::indexed_by <
    boost::multi_index::random_access < boost::multi_index::tag <RandomAccessIndex> >,
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransactionIndex>,
      boost::multi_index::member<CryptAthlos::WalletTransaction, Crypto::Hash, &CryptAthlos::WalletTransaction::hash >
    >,
    boost::multi_index::ordered_non_unique < boost::multi_index::tag <BlockHeightIndex>,
      boost::multi_index::member<CryptAthlos::WalletTransaction, uint32_t, &CryptAthlos::WalletTransaction::blockHeight >
    >
  >
> WalletTransactions;

typedef std::pair<size_t, CryptAthlos::WalletTransfer> TransactionTransferPair;
typedef std::vector<TransactionTransferPair> WalletTransfers;
typedef std::map<size_t, CryptAthlos::Transaction> UncommitedTransactions;
