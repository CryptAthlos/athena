...
inline std::error_code make_error_code(CryptAthlos::error::WalletErrorCodes e) {
  return std::error_code(static_cast<int>(e), CryptAthlos::error::WalletErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<CryptAthlos::error::WalletErrorCodes>: public true_type {};
