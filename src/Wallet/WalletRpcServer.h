...
namespace Tools
{
  ...
  /*                                                                      */
  /************************************************************************/
  class wallet_rpc_server : CryptAthlos::HttpServer
  {
  public:
  ...
  private:
    ...
    virtual void processRequest(const CryptAthlos::HttpRequest& request, CryptAthlos::HttpResponse& response) override;
