...
public:
  WalletLegacy(const CryptAthlos::Currency& currency, INode& node);
...
private:
  ...
  CryptAthlos::AccountBase m_account;
  ...
  Tools::ObserverManager<CryptAthlos::IWalletLegacyObserver> m_observerManager;
