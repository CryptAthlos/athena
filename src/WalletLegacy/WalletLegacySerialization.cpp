...
void serialize(UnconfirmedTransferDetails& utd, CryptAthlos::ISerializer& serializer) {
...
void serialize(WalletLegacyTransaction& txi, CryptAthlos::ISerializer& serializer) {
  ...
  CryptAthlos::serializeBlockHeight(serializer, txi.blockHeight, "block_height");
...
void serialize(WalletLegacyTransfer& tr, CryptAthlos::ISerializer& serializer) {
