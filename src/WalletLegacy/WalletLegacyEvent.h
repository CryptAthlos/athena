...
public:
  ...
  virtual void notify(Tools::ObserverManager<CryptAthlos::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<CryptAthlos::IWalletLegacyObserver>& observer) override
  {
