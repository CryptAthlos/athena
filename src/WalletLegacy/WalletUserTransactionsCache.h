...
public:
  ...
  bool serialize(CryptAthlos::ISerializer& serializer);
  ...
  void updateTransaction(TransactionId transactionId, const CryptAthlos::Transaction& tx, uint64_t amount, const std::list<TransactionOutputInformation>& usedOutputs);
