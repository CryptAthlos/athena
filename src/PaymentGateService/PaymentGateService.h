...
public:
  ...
  const CryptAthlos::Currency getCurrency();
...
private:
  ...
  void runWalletService(const CryptAthlos::Currency& currency, CryptAthlos::INode& node);

  System::Dispatcher* dispatcher;
  System::Event* stopEvent;
  PaymentService::ConfigurationManager config;
  PaymentService::WalletService* service;
  CryptAthlos::CurrencyBuilder currencyBuilder;
